...
def stats(nbParties,joueur):
    """ int,int->int
    Retourne le nombre de parties total, gagnées et nuls
    """
    nbGagne = 0
    nbNul = 0
...
def apprentissageNonSupervise(nbMax = 100):
    ...
    nbParties = 20 # nombre de parties sur lequel on teste chaque poids
...
def nonSuperviseGraphique():
    ...
    plt.ylim(0,100)
    plt.title("Taux de victoire d'alphabeta en fonction du temps (Awélé)")
...
apprentissageNonSupervise(1000) # 1000 explorations, 20 parties par exploration
